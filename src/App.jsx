...
function Showroom3D({ onEnter }) {
  ...
  useEffect(()=>{
    ...
    const floorMat = new THREE.MeshStandardMaterial({ color:0x0a0a0a, metalness:0.9, roughness:0.1 });
    ...
    const m1 = createMannequin(-4.5, 0x8b3a6b, true);
    const m2 = createMannequin(-2.5, 0x2d5a8e, true);
    const m3 = createMannequin(2.5,  0x3d6b3a, false);
    const m4 = createMannequin(4.5,  0x6b4423, false);
    ...
    <div style={{position:"fixed",inset:0,zIndex:99999,background:"#030303"}}>
      ...
      <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",pointerEvents:"none",zIndex:2}}>
        <div style={{opacity:textVisible?1:0,transition:"opacity 1.5s ease",textAlign:"center",padding:"0 20px"}}>
          <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(11px,1.5vw,14px)",letterSpacing:"8px",color:"#c9a84c88",marginBottom:"16px",fontStyle:"italic",animation:textVisible?"fadeUp 0.8s ease both":"none"}}>✦ EST. KUNJAH ✦</div>
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(36px,7vw,80px)",fontWeight:"900",letterSpacing:"6px",background:"linear-gradient(135deg,#c9a84c,#e8c97a,#c9a84c)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",marginBottom:"8px",animation:textVisible?"fadeUp 0.8s ease 0.2s both":"none",lineHeight:"1"}}>{BRAND}</div>
          <div style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(14px,2vw,20px)",letterSpacing:"12px",color:"#c9a84c99",marginBottom:"24px",animation:textVisible?"fadeUp 0.8s ease 0.4s both":"none"}}>{BRAND_SUB}</div>
          ...
          <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(13px,1.8vw,17px)",color:"#c9a84c77",fontStyle:"italic",letterSpacing:"3px",animation:textVisible?"fadeUp 0.8s ease 0.8s both":"none"}}>{TAGLINE}</div>
        </div>
      </div>
      {phase>=3&&(
        <div style={{position:"absolute",bottom:"10%",left:0,right:0,display:"flex",justifyContent:"center",zIndex:3}}>
          <button onClick={onEnter} style={{background:"linear-gradient(135deg,#c9a84c,#e8c97a)",color:"#000",border:"none",borderRadius:"30px",padding:"14px 48px",fontSize:"13px",fontWeight:"800",letterSpacing:"3px",textTransform:"uppercase",cursor:"pointer",animation:"fadeUp 0.6s ease both",boxShadow:"0 8px 32px rgba(201,168,76,0.4)",fontFamily:"'DM Sans',sans-serif"}}>Enter Store →</button>
        </div>
      )}
      <button onClick={onEnter} style={{position:"absolute",top:"20px",right:"20px",background:"none",border:"1px solid #c9a84c33",borderRadius:"20px",padding:"6px 16px",color:"#c9a84c88",fontSize:"11px",cursor:"pointer",letterSpacing:"2px",zIndex:3,fontFamily:"'DM Sans',sans-serif"}}>Skip ›</button>
    </div>
  );
}
      ...
      <div style={{background:"#0a0a0a",borderRadius:"20px",width:"100%",maxWidth:"540px",border:"1px solid #c9a84c22",overflow:"hidden",animation:"scaleIn 0.3s ease",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        <div style={{padding:"24px"}}>
          <div style={{display:"flex",gap:"8px",marginBottom:"20px"}}>
            ...
            <button onClick={search} className="btn-gold" style={{borderRadius:"10px",padding:"11px 20px",fontSize:"13px",letterSpacing:"1px"}}>{loading?"⏳":"Search"}</button>
          </div>
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"#050505",zIndex:99999,display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden"}}>
      ...
      <div style={{textAlign:"center",position:"relative",zIndex:1}}>
        ...
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(24px,5vw,52px)",fontWeight:"900",letterSpacing:"8px",background:"linear-gradient(135deg,#c9a84c,#e8c97a,#c9a84c)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",opacity:phase>=1?1:0,transform:phase>=1?"translateY(0)":"translateY(20px)",transition:"all 0.9s cubic-bezier(0.16,1,0.3,1)",animation:phase>=3?"shimmer 2s ease infinite":"none"}}>{BRAND}</div>
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(13px,2vw,18px)",letterSpacing:"12px",color:"#c9a84c88",marginTop:"6px",opacity:phase>=2?1:0,transition:"opacity 0.8s ease 0.2s"}}>{BRAND_SUB}</div>
        ...
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(12px,1.5vw,15px)",letterSpacing:"4px",color:"#c9a84c77",fontStyle:"italic",opacity:phase>=2?1:0,transition:"opacity 0.8s ease 0.5s"}}>{TAGLINE}</div>
  ...
  return (
    <div style={{background:"linear-gradient(135deg,#1a1208,#2a1f0a,#1a1208)",borderBottom:"1px solid #c9a84c22",overflow:"hidden",height:"34px",display:"flex",alignItems:"center"}}>
      <div style={{display:"flex",animation:"marquee 25s linear infinite",whiteSpace:"nowrap"}}>
        {all.map((a,i)=>(
          <span key={i} style={{padding:"0 40px",fontSize:"11px",letterSpacing:"2px",color:"#c9a84c",fontFamily:"'DM Sans',sans-serif",fontWeight:"500"}}>{a}</span>
        ))}
      </div>
    </div>
  );
      ...
      <nav style={{position:"fixed",top:"34px",left:0,right:0,zIndex:500,background:scrolled?"rgba(5,5,5,0.95)":"transparent",backdropFilter:scrolled?"blur(20px)":"none",borderBottom:scrolled?"1px solid #c9a84c22":"none",transition:"all 0.4s ease"}}>
        <div style={{maxWidth:"1400px",margin:"0 auto",padding:"0 24px",height:"64px",display:"flex",alignItems:"center",gap:"20px"}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:"8px",flexShrink:0}}>
            <button onClick={()=>setShowSearch(s=>!s)} style={{background:"none",border:"none",color:"#b0a898",width:"36px",height:"36px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px",borderRadius:"50%",transition:"all 0.2s"}}>🔍</button>
            <button onClick={()=>customer?setPage("wishlist"):setShowLogin(true)} style={{background:"none",border:"none",color:"#b0a898",width:"36px",height:"36px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px",borderRadius:"50%",position:"relative"}}>
            ...
            <button onClick={()=>setShowCart(true)} style={{background:"none",border:"none",color:"#b0a898",width:"36px",height:"36px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px",borderRadius:"50%",position:"relative"}}>
            ...
            <button onClick={()=>customer?setPage("account"):setShowLogin(true)} style={{background:"none",border:"1px solid #c9a84c44",borderRadius:"20px",padding:"6px 14px",color:"#c9a84c",fontSize:"11px",fontWeight:"600",letterSpacing:"1px",transition:"all 0.2s"}}>
  ...
  return (
    <section style={{position:"relative",minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",background:"#050505"}}>
      <div style={{position:"absolute",inset:0,overflow:"hidden"}}>
        <div style={{position:"absolute",inset:0,background:"radial-gradient(ellipse at 30% 50%,#c9a84c08 0%,transparent 60%),radial-gradient(ellipse at 70% 50%,#8b691405 0%,transparent 60%)"}}/>
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center",padding:"0 24px",maxWidth:"900px",margin:"0 auto"}}>
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(12px,1.5vw,14px)",letterSpacing:"6px",color:"#c9a84c88",marginBottom:"20px",fontStyle:"italic",opacity:loaded?1:0,transition:"opacity 0.8s ease"}}>✦ PREMIUM PAKISTANI COLLECTION ✦</div>
        <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(36px,6vw,80px)",fontWeight:"900",lineHeight:"1.1",marginBottom:"24px",opacity:loaded?1:0,transition:"opacity 0.8s 0.2s"}}>
          <span className="gold-text"><RotatingText texts={settings.heroTexts||[settings.heroTitle||"Where Elegance Meets Pakistani Heritage"]}/></span>
        </h1>
        <p style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(16px,2vw,22px)",color:"#b0a898",lineHeight:"1.7",marginBottom:"40px",fontStyle:"italic",maxWidth:"650px",margin:"0 auto 40px",opacity:loaded?1:0,transition:"opacity 0.8s 0.4s"}}>{settings.heroSubtitle}</p>
        <div style={{display:"flex",gap:"16px",justifyContent:"center",flexWrap:"wrap",opacity:loaded?1:0,transition:"opacity 0.8s 0.6s"}}>
          <button onClick={()=>{setCatFilter("All");setPage("shop");}} className="btn-gold" style={{borderRadius:"30px",padding:"14px 36px",fontSize:"13px",letterSpacing:"2px",textTransform:"uppercase"}}>Explore Collection</button>
          <a href={`https://wa.me/${WA_NUM}?text=${encodeURIComponent("Assalam o Alaikum! I'd like to see your latest collection.")}`} target="_blank" rel="noreferrer" className="btn-outline" style={{borderRadius:"30px",padding:"14px 36px",fontSize:"13px",letterSpacing:"2px",textTransform:"uppercase",display:"inline-block"}}>📱 WhatsApp Us</a>
        </div>
        <div style={{display:"flex",justifyContent:"center",gap:"clamp(20px,5vw,60px)",marginTop:"64px",opacity:loaded?1:0,transition:"opacity 0.8s 0.8s",flexWrap:"wrap"}}>
    ...
    <div ref={ref} className="prod-card" style={{opacity:inView?1:0,transform:inView?"translateY(0)":"translateY(32px)",transition:`all 0.7s cubic-bezier(0.16,1,0.3,1) ${index*0.08}s`}}>
      <div onMouseEnter={()=>setHovered(true)} onMouseLeave={()=>setHovered(false)} style={{background:"#0f0f0f",borderRadius:"16px",overflow:"hidden",border:`1px solid ${hovered?"#c9a84c44":"#1a1a1a"}`,boxShadow:hovered?"0 24px 64px rgba(201,168,76,0.12)":"none",transition:"all 0.4s"}}>
        <div style={{position:"relative",aspectRatio:"3/4",overflow:"hidden",cursor:"pointer"}} onClick={()=>onView(product)}>
          ...
          <button onClick={e=>{e.stopPropagation();toggleWish(product.id);}} style={{position:"absolute",top:"12px",right:"12px",background:wished?"#c9a84c":"rgba(0,0,0,0.5)",border:"none",borderRadius:"50%",width:"34px",height:"34px",cursor:"pointer",fontSize:"14px",display:"flex",alignItems:"center",justifyContent:"center",transition:"all 0.2s",backdropFilter:"blur(8px)"}}>{wished?"❤️":"🤍"}</button>
          {hovered&&product.stock>0&&(
            <button onClick={e=>{e.stopPropagation();onAddCart(product);}} className="btn-gold" style={{position:"absolute",bottom:"12px",left:"12px",right:"12px",borderRadius:"8px",padding:"10px",fontSize:"11px",letterSpacing:"1px",textTransform:"uppercase",animation:"fadeUp 0.2s ease both"}}>+ Add to Cart</button>
          )}
          <div style={{position:"absolute",bottom:"12px",left:"12px",background:"rgba(0,0,0,0.6)",color:"#ccc",padding:"2px 8px",borderRadius:"20px",fontSize:"10px",backdropFilter:"blur(4px)",opacity:hovered?0:1,transition:"opacity 0.2s"}}>👁 {product.views||0}</div>
        </div>
...
// ── Product Modal ─────────────────────────────────────────────
function ProductModal({ product, onClose, wishlist, toggleWish, onAddCart, reviews, onAddReview, settings }) {
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr"}} className="grid-1-mobile">
          ...
          <div style={{padding:"24px",display:"flex",flexDirection:"column",gap:"14px"}}>
            ...
            <div style={{background:"#111",borderRadius:"12px",padding:"14px",border:"1px solid #1a1a1a"}}>
              ...
              <div style={{fontSize:"12px",color:"#555",marginTop:"4px"}}>{product.stock>0?`✅ Available${product.stock===1?" — Last piece!":""}` :"❌ Sold Out"}</div>
            </div>
            ...
            <div style={{fontSize:"13px",color:"#b0a898",lineHeight:"1.8",minHeight:"80px",flex:1,overflowY:"auto"}}>
              {tab==="details"&&<p>{product.description||"Premium quality exclusive fabric from Jameel Fabrics Kunjah. Each piece is unique — once sold, it's gone forever."}</p>}
            ...
            {product.stock>0?(
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"8px",marginTop:"auto"}}>
                ...
                <a href={`https://wa.me/${settings.whatsapp||WA_NUM}?text=${encodeURIComponent(waText)}`} target="_blank" rel="noreferrer" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"6px",background:"#25D366",color:"#fff",borderRadius:"12px",padding:"13px",fontWeight:"700",fontSize:"12px",letterSpacing:"1px",textTransform:"uppercase"}}>📱 Enquire</a>
              </div>
            ):(
              <a href={`https://wa.me/${settings.whatsapp||WA_NUM}?text=${encodeURIComponent(`Assalam! "${product.name}" is sold out. Do you have something similar?`)}`} target="_blank" rel="noreferrer" style={{display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",background:"#25D366",color:"#fff",borderRadius:"12px",padding:"13px",fontWeight:"700",fontSize:"13px",textDecoration:"none",marginTop:"auto"}}>📱 Ask for Similar Item</a>
            )}
          </div>
        </div>
      </div>
      ...
      <div style={{position:"absolute",right:0,top:0,bottom:0,width:"min(420px,100vw)",background:"#0a0a0a",borderLeft:"1px solid #c9a84c22",display:"flex",flexDirection:"column",animation:"slideLeft 0.3s ease"}}>
        ...
        {cart.length>0&&(
          <div style={{padding:"16px 24px",borderTop:"1px solid #1a1a1a"}}>
            ...
            <button onClick={()=>{customer?setShowCheckout(true):setShowLogin(true);}} className="btn-gold" style={{width:"100%",borderRadius:"12px",padding:"14px",fontSize:"13px",letterSpacing:"2px",textTransform:"uppercase",marginBottom:"8px"}}>Checkout via WhatsApp</button>
...
function CheckoutModal({ cart, customer, onClose, settings, coupon }) {
  ...
  const total = coupon ? Math.max(0, subtotal - coupon.discount) : subtotal;
  const orderText = [
    `🛍️ *NEW ORDER — JAMEEL FABRICS KUNJAH*`,`━━━━━━━━━━━━━━━━━━━━`,`👤 *Customer Details*`,
    `Name: ${customer?.name}`,`Phone: ${customer?.phone}`,`City: ${customer?.city}`,`Address: ${customer?.address}`,
    `━━━━━━━━━━━━━━━━━━━━`,`📦 *Order Items*`,
    ...cart.map((item,i)=>`${i+1}. ${item.name}\n   ${item.color} | Qty: ${item.qty} | ${pkr(item.price*item.qty)}`),
    `━━━━━━━━━━━━━━━━━━━━`,
    coupon?`🎫 Coupon: ${coupon.code} (-Rs.${coupon.discount.toLocaleString()})`:null,
    `💰 *Total: ${pkr(total)}*`,`💳 Payment: Cash on Delivery`,`━━━━━━━━━━━━━━━━━━━━`,
    `Order Date: ${new Date().toLocaleString()}`,`Please confirm this order. Thank you! 🙏`,
  ].filter(Boolean).join("\n");
  return (
              ...
              if(supabase){
                for(const item of cart){
                  await supabase.from("online_orders").insert({
                    ...
                    product_price:item.price,customer_name:customer.name,phone:customer.phone,
      ...
      <div style={{padding:"12px"}}>
        ...
        {showActions&&(
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"5px"}}>
            ...
            {p.website_status==="listed"&&<button onClick={()=>updateWebsiteStatus(p.id,"hidden")} style={{background:"#11111122",color:"#555",border:"1px solid #2a2a2a",borderRadius:"8px",padding:"6px",cursor:"pointer",fontSize:"10px",fontWeight:"700"}}>🙈 Hide</button>}
      ...
      <div style={{flex:1,overflow:"auto",padding:"20px"}}>
        {tab==="pending"&&(
          <div>
            ...
            {!loadingProds&&pendingProds.length===0&&<div style={{color:"#444",textAlign:"center",padding:"60px"}}><div style={{fontSize:"36px",marginBottom:"12px"}}>✅</div><div>No pending products!</div></div>}
        ...
        {tab==="alerts"&&(
          <div>
            ...
            {alerts.length===0&&<div style={{color:"#444",textAlign:"center",padding:"60px"}}><div style={{fontSize:"36px",marginBottom:"12px"}}>🔕</div><div>No alerts yet.</div></div>}
        ...
        {tab==="all"&&!editProd&&(
          <div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:"12px"}}>
              ...
              {allProds.length===0&&<div style={{color:"#444",textAlign:"center",padding:"40px",gridColumn:"1/-1"}}>Koi product nahi</div>}
            </div>
          </div>
        )}
        ...
        {(tab==="all"||tab==="pending"||tab==="listed")&&editProd&&(
          <div style={{maxWidth:"800px"}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:"16px"}}>
              <span style={{color:"#c9a84c",fontWeight:"700",fontSize:"16px"}}>✏️ Edit: {editProd.name}</span>
            ...
            <div style={{background:"#0f0f0f",border:"1px solid #1a1a1a",borderRadius:"16px",padding:"20px"}}>
              <div style={{marginBottom:"14px"}}>
                ...
                <div style={{display:"flex",gap:"6px",flexWrap:"wrap"}}>
                  {Object.entries(STATUS_L).map(([k,l])=>(
                    <button key={k} onClick={()=>setEditProd(p=>({...p,website_status:k}))} style={{background:editProd.website_status===k?STATUS_C[k]+"33":"#111",color:editProd.website_status===k?STATUS_C[k]:"#555",border:`1px solid ${editProd.website_status===k?STATUS_C[k]:"#1a1a1a"}`,borderRadius:"20px",padding:"5px 12px",cursor:"pointer",fontSize:"11px",fontWeight:"700"}}>{l}</button>
                  ))}
                </div>
              </div>
              ...
              <div style={{marginBottom:"10px"}}>{inp("Website Description","website_description","textarea")}</div>
              ...
              <div style={{marginTop:"12px"}}>
                ...
                {uploading&&<p style={{color:"#c9a84c",fontSize:"11px",marginTop:"6px"}}>⏳ Uploading...</p>}
              </div>
          ...
          <div style={{maxWidth:"600px"}}>
            ...
            <div style={{background:"#0f0f0f",border:"1px solid #c9a84c22",borderRadius:"16px",padding:"20px"}}>
              ...
              <label style={{display:"flex",alignItems:"center",gap:"6px",cursor:"pointer",fontSize:"12px",color:"#f0ebe0",marginBottom:"10px"}}>
                <input type="checkbox" checked={!!sEdit.showUploadedVideo} onChange={e=>setSEdit(s=>({...s,showUploadedVideo:e.target.checked}))} style={{accentColor:"#c9a84c"}}/>Show Video on Homepage
              </label>
...
function OrdersAdmin() {
  ...
  useEffect(()=>{
    ...
    supabase.from("online_orders").select("*").order("created_at",{ascending:false}).then(({data})=>{ setOrders(data||[]); setLoading(false); });
  ...
  return (
    <div>
      ...
      {!supabase&&<div style={{background:"#e0525211",border:"1px solid #e0525233",borderRadius:"10px",padding:"12px",marginBottom:"12px",fontSize:"12px",color:"#e05252"}}>⚠️ Supabase not connected</div>}
      <div style={{display:"grid",gap:"10px"}}>
        {orders.map(o=>(
          <div key={o.id} style={{background:"#0f0f0f",border:`1px solid ${STATUS_C[o.status]||"#1a1a1a"}22`,borderRadius:"14px",padding:"14px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"6px",fontSize:"11px",color:"#777",marginBottom:"10px"}}>
              <div>👤 {o.customer_name}</div><div>📞 {o.phone}</div>
              <div>🏙️ {o.city}</div><div>📍 {o.address}</div>
            </div>
            ...
            <div style={{display:"flex",gap:"6px",flexWrap:"wrap",alignItems:"center"}}>
              ...
              {STATUS.map(s=>(
                <button key={s} onClick={()=>updateStatus(o.id,s)} style={{background:o.status===s?STATUS_C[s]||"#c9a84c":"#111",color:o.status===s?"#fff":"#555",border:`1px solid ${STATUS_C[s]||"#1a1a1a"}44`,borderRadius:"20px",padding:"3px 10px",cursor:"pointer",fontSize:"10px",fontWeight:"600",transition:"all 0.2s"}}>{s}</button>
              ))}
              <a href={`https://wa.me/92${(o.phone||"").replace(/^0/,"")}?text=${encodeURIComponent(`Assalam ${o.customer_name}! Your order "${o.product_name}" is now ${o.status}. — Jameel Fabrics Kunjah`)}`} target="_blank" rel="noreferrer" style={{marginLeft:"auto",background:"#25D366",color:"#fff",borderRadius:"20px",padding:"3px 10px",fontSize:"10px",fontWeight:"700"}}>📱 WA</a>
            </div>
          </div>
        ))}
  ...
  return (
    <section ref={ref} style={{padding:"80px 24px",maxWidth:"1400px",margin:"0 auto"}}>
      <div style={{textAlign:"center",marginBottom:"48px",opacity:inView?1:0,transform:inView?"translateY(0)":"translateY(24px)",transition:"all 0.8s ease"}}>
        ...
        <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(28px,4vw,44px)",fontWeight:"700"}}><span className="gold-text">Trending Now</span></h2>
  ...
  return (
    <section ref={ref} id="about" style={{padding:"80px 24px",background:"#0a0808",borderTop:"1px solid #1a1a1a",borderBottom:"1px solid #1a1a1a"}}>
      <div style={{maxWidth:"900px",margin:"0 auto",textAlign:"center",opacity:inView?1:0,transition:"all 0.8s ease",transform:inView?"translateY(0)":"translateY(24px)"}}>
        ...
        <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(26px,4vw,42px)",fontWeight:"700",marginBottom:"32px"}}>About <span className="gold-text">{BRAND}</span></h2>
        ...
        <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(16px,2vw,20px)",color:"#b0a898",lineHeight:"2",textAlign:"left",whiteSpace:"pre-line"}}>{settings.aboutText}</div>
  ...
  return (
    <section ref={ref} id="location" style={{padding:"80px 24px",background:"#070707",borderTop:"1px solid #1a1a1a"}}>
      <div style={{maxWidth:"900px",margin:"0 auto",textAlign:"center",opacity:inView?1:0,transition:"all 0.8s ease",transform:inView?"translateY(0)":"translateY(24px)"}}>
        ...
        <a href={MAPS_URL} target="_blank" rel="noreferrer" className="btn-outline" style={{display:"inline-block",marginTop:"20px",borderRadius:"30px",padding:"12px 28px",fontSize:"12px",letterSpacing:"2px",textTransform:"uppercase"}}>📍 Open in Google Maps</a>
      </div>
    </section>
  );
}
      ...
      <div style={{maxWidth:"1200px",margin:"0 auto"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:"32px",marginBottom:"40px"}}>
          <div>
            ...
            <div style={{display:"flex",gap:"10px",marginTop:"16px"}}>
              {settings.tiktokUrl&&<a href={settings.tiktokUrl} target="_blank" rel="noreferrer" style={{width:"36px",height:"36px",background:"#111",border:"1px solid #1a1a1a",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px"}}>🎵</a>}
              {settings.instagramUrl&&<a href={settings.instagramUrl} target="_blank" rel="noreferrer" style={{width:"36px",height:"36px",background:"#111",border:"1px solid #1a1a1a",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"16px"}}>📸</a>}
          ...
          <div>
            ...
            {[["Home","#"],["Men's Collection","#mens"],["Women's Collection","#womens"],["About Us","#about"],["Policies","#policies"],["Contact","#location"]].map(([l,h])=>(
              <a key={l} href={h} style={{display:"block",fontSize:"13px",color:"#555",padding:"5px 0",transition:"color 0.2s"}} onMouseEnter={e=>e.target.style.color="#c9a84c"} onMouseLeave={e=>e.target.style.color="#555"}>{l}</a>
            ))}
          </div>
          <div>
        ...
        <>
          ...
          {settings.showVideo&&settings.featuredVideo&&(
            <section style={{padding:"80px 24px",textAlign:"center",background:"#070707",borderTop:"1px solid #1a1a1a"}}>
              ...
              <div style={{maxWidth:"800px",margin:"0 auto",borderRadius:"16px",overflow:"hidden",border:"1px solid #c9a84c22"}}>
            ...
            <section style={{padding:"80px 24px",background:"#040404",borderTop:"1px solid #c9a84c11"}}>
              <div style={{maxWidth:"900px",margin:"0 auto"}}>
                <div style={{textAlign:"center",marginBottom:"36px"}}>
                  ...
                  {settings.uploadedVideoTitle&&<h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(24px,4vw,44px)",fontWeight:"700"}}><span className="gold-text">{settings.uploadedVideoTitle}</span></h2>}
                  <div style={{height:"1px",background:"linear-gradient(to right,transparent,#c9a84c,transparent)",maxWidth:"200px",margin:"16px auto 0"}}/>
                </div>
                <div style={{position:"relative",borderRadius:"16px",overflow:"hidden",border:"1px solid #c9a84c22",background:"#000"}}>
                  <video src={settings.uploadedVideoUrl} controls controlsList="nodownload" style={{width:"100%",maxHeight:"560px",display:"block",objectFit:"cover"}}/>
                  {["top-left","top-right","bottom-left","bottom-right"].map(pos=>(
                    <div key={pos} style={{position:"absolute",...(pos.includes("top")?{top:0}:{bottom:0}),...(pos.includes("left")?{left:0}:{right:0}),width:"30px",height:"30px",borderTop:pos.includes("top")?"2px solid #c9a84c":undefined,borderBottom:pos.includes("bottom")?"2px solid #c9a84c":undefined,borderLeft:pos.includes("left")?"2px solid #c9a84c":undefined,borderRight:pos.includes("right")?"2px solid #c9a84c":undefined}}/>
                  ))}
                </div>
                      ...
                      <tbody>
                        {settings.uploadedVideoCaption.split("\n").filter(Boolean).map((line,i)=>(
                          <tr key={i} style={{background:i%2===0?"#0f0f0f":"#111"}}>
                            <td style={{padding:"11px 20px",fontSize:"13px",color:"#b0a898",lineHeight:"1.7",borderBottom:"1px solid #0a0a0a"}}>{line}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
